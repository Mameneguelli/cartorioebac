...
int registro()// Função responsavel por cadastrar os usuários no sistema
{
	...
	strcpy(arquivo, cpf);// Respondavel por copiar os valores das string
	
	FILE *file;// cria o arquivo
	file = fopen(arquivo, "w");//cria o arquivo e o w sigfica escrever
...
int main()
	{
	int opcao=0;//Definindo bariáveis
	int laco=1;
